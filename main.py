...
def parse_args(args=None):
    ...
    parser.add_argument('--valid_epoch', default=5, type=int, help='validation frequency.')
...
def main(args):
    ...
    if not os.path.exists(state_actions_path):
        ...
        state_action_space = joblib.load(open(os.path.join(args.data_path, args.state_actions_path), 'rb+'))
